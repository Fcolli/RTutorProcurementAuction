...
ps.dir =  'C:/Users/Freddy/Desktop/MasterarbeitGitHub' # set to the folder in which this file is stored
ps.file = 'RTutorProcurementAuction.Rmd' # set to the name of this file
user.name = '' # set to your user name

library(RTutor)
check.problem.set('RTutorProcurementAuction', ps.dir, ps.file, user.name=user.name, reset=FALSE)
...
#! addon__quiz__Item Codes and what they Stand for
...
```{r "3_2__3",optional=TRUE}
# Enter your command here
```


#! addon__quiz__distance
...
```{r "3_2__4",results='asis', output='htmlwidget', widget='leaflet', optional=TRUE}
present.map()
```
<br>
...
```{r "3_2__13",optional=TRUE}
# Enter your command here
```


#! addon__quiz__last1.5
...
info("t-Values of the Regression") # Run this line (Strg-Enter) to show info
...
```{r "4__2",optional=TRUE}
# Enter your code here
```

#! addon__quiz__adaptions
...
info("tab.summary()") # Run this line (Strg-Enter) to show info
...
```{r "4__10",optional=TRUE}
# Enter your command here
```

#! addon__quiz__adaption costs3
    
#! addon__quiz__adaption costs4
...
#! addon__quiz__adaption_costs_model1

#! addon__quiz__adaption_costs_model2
...
info("Calculus") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__Adaption costs 12
...
info("Check if Instruments are Correlated with Regressors") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__Adaption costs example
